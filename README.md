...
```html
cd /usr/bin && wget https://raw.githubusercontent.com/Rendezvous07/RVPNCloud/main/ssh/slhost.sh && bash slhost.sh
 ```
...
* lalu update cert
```html
wget https://raw.githubusercontent.com/Rendezvous07/RVPNCloud/main/xray/certv2ray.sh && chmod +x certv2ray.sh && bash certv2ray.sh
 ```
* atau
```html
certv2ray
