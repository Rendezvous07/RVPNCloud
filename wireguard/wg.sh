...
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/Rendezvous07/RVPNCloud/main/wireguard"
...
echo -e "${Info} Wireguard Script Mod By Rendez"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Rendezvous07/RVPNCloud/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Rendezvous07/RVPNCloud/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Rendezvous07/RVPNCloud/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
